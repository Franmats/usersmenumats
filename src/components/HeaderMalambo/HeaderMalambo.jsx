import "./HeaderMalambo.css"

export const HeaderMalambo = ()=> {
       
  return (
    <div>
        <header>
            <div className="header-contain-malambo">
              <div className="header-image-malambo">
                      <img src="https://firebasestorage.googleapis.com/v0/b/super-ecommerce-f7347.appspot.com/o/logomalambo.png?alt=media&token=d3d97696-8d2c-418b-9ead-279b8d2a0ffe" alt="logo"  width="250px" height="250px"/>
              </div>  
                <div className="c1-malambo">
                      <div className="social-links-malambo">
